...
public class JwtTokenUtils {
     ...
     * JWT的发行人
     */
    private static final String ISS = "ymtNSN";
    ...
    public static void main(String[] args) {
        String token = Jwts.builder().signWith(SignatureAlgorithm.HS512, SECRET) // 加密算法
                .setClaims(null) // 自定义信息
                .setIssuer(ISS) // jwt发行人
                .setSubject("ymt") // jwt面向的用户
                .setIssuedAt(new Date()) // jwt发行人
                .setExpiration(new Date(System.currentTimeMillis()+ 3600)) // key过期时间
                .compact();
